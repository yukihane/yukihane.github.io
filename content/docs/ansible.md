...
- [ansibleでLinuxユーザーの作成と鍵認証を設定する - Qiita](http://qiita.com/komitomo/items/e78855fa1ccee1737ac7)

[^1]: [Inventory — Ansible Documentation](http://docs.ansible.com/ansible/intro_inventory.html)
