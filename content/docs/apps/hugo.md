...
[klakeggさん？](https://discourse.gohugo.io/t/klakeggs-wonderful-hugo-docker-image-update-thread/20347)のイメージを用いることにする。

- [dockerhub](https://hub.docker.com/r/klakegg/hugo/)

# quickstart

公式サイトの [Quick Start](https://gohugo.io/getting-started/quick-start/) 節を実行してみる。
...
- [Configure Hugo](https://gohugo.io/getting-started/configuration/) - config.toml の設定内容

- [Front Matter](https://gohugo.io/content-management/front-matter/) - postのヘッダに書く内容
