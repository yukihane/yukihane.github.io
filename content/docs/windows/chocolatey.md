...
[Not setting tab completion · Issue \#991 · chocolatey/choco](https://github.com/chocolatey/choco/issues/991) によるとファイルサイズが4バイト以上無ければならないようなので、適当に数文字コメントを書いておく。このコメントはインストール後削除すれば良い。
