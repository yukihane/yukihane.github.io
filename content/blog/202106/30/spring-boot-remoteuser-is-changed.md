...
`HttpServletRequest#getRemoteUser()` をログ出力(Tomcatの [`%u`](https://tomcat.apache.org/tomcat-9.0-doc/config/valve.html#Access_Log_Valve/Attributes))しているのですが、Spring Boot 2.5.0 から返ってくる値が変わったようです。

どの変更が影響しているのか調べたところ、次のものが該当するようです。

- [5.5.0-M2 Release Notes](https://github.com/spring-projects/spring-security/releases/tag/5.5.0-M2)

  - [getRemoteUser() returns principal name \#9211](https://github.com/spring-projects/spring-security/pull/9211)

実際にどうなったか見てみます。

- [KeycloakをIdPにしてSpring Security OAuth 2.0 Login/Client を試してみる – 発火後忘失](https://yukihane.github.io/blog/202007/21/hello-oidc-with-keycloak/)
