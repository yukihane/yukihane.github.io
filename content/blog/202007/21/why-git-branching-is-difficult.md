...
ということです。 Gitのブランチングは、比較的共通言語化([successful git branching model(git flow)](https://nvie.com/posts/a-successful-git-branching-model/) だとか、 [github flow](https://guides.github.com/introduction/flow/)だとか)しているにも関わらず、実際にこれらに従って開発したことがある人の割合が想像以上に低いです。
...
- [git flowの図](https://nvie.com/img/git-model@2x.png)で言うところの `develop` ブランチを複数本用意しなければ行けない状況
