...
Mavenでは [formatter-maven-plugin](https://github.com/revelc/formatter-maven-plugin) を利用していました。
...
GradleでEclipseのフォーマッタ設定を流用できそうなものとしては [spotless](https://github.com/diffplug/spotless) というものがあるようです。
...
結論としては、 [ここ](https://github.com/mapstruct/mapstruct-examples/blob/master/mapstruct-lombok/build.gradle) にあるような書き方で行けそうなんじゃないかな、と。
...
- [Annotation Processor configuration from Gradle Eclipse Plugin \#329](https://github.com/eclipse/buildship/issues/329) - eclipse/buildship
