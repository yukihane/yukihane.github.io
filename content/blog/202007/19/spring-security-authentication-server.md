...
>
> —  [Spring Security OAuth2はあと数年でサポート終了、その代替策 - Qiita](https://qiita.com/suke_masa/items/4e68012e3b8c92822a9a)

と書かれた記事がありますが、その後この計画は見直されています。

- [Announcing the Spring Authorization Server](https://spring.io/blog/2020/04/15/announcing-the-spring-authorization-server) - Spring Blog
