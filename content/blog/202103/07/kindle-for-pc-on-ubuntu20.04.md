...
- [Ubuntu20.04 で Kindle for PCを使う]({{< relref"/docs/ubuntu/kindle-for-pc-ubuntu20.04" >}})

- (参考)16.04, 18.04時代のもの: [UbuntuでKindle for PCを使う]({{< relref"/docs/ubuntu/kindle-for-pc" >}})
