...
- 参考: [Using Git for Windows](https://conemu.github.io/en/GitForWindows.html) - オフィシャルリファレンス
...
- 参考: [\_\_sdkman_post_installation_hook: command not found \#593](https://github.com/sdkman/sdkman-cli/issues/593#issuecomment-467767923)

# Git初期設定

Git for Windows は [`core.autocrlf`](https://git-scm.com/book/ja/v2/Git-%E3%81%AE%E3%82%AB%E3%82%B9%E3%82%BF%E3%83%9E%E3%82%A4%E3%82%BA-Git-%E3%81%AE%E8%A8%AD%E5%AE%9A#_code_core_autocrlf_code) の設定がデフォルトで `true` になっているのでこれを変更しておきます。また、名前とemailの設定も行います。
...
前述の通り、Java関連のツールはなるべくSDKMAN!で管理することにしています。 Scoopでも [Java bucket](https://github.com/lukesampson/scoop/wiki/Java)をインストールすることで各種JDKを取り扱えるようになりますが、SDKMAN!の方がJDKの切り替えに柔軟性があったり、他OSとやりかたが統一できたりというメリットがあると考え、SDKMAN!を使っています。
...
- [Windows(Cygwin)でSDKMANがうまく動かないのはcurlのせい](https://nowokay.hatenablog.com/entry/2019/06/12/035324) - きしだのはてな
